...
#define NUM_MAX_CONNECTED_GAMEPADS 4
#define NUM_GAMEPAD_AXIS_AMOUNT 6

#define VAL_LAST 0
#define VAL_CURRENT 1
#define VAL_NEXT 2

enum class InputType : ui8 { Keyboard_Mouse, Gamepad };

enum class GamepadButton : ui8 
{
